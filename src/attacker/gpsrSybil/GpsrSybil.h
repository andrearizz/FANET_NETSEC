...
class INET_API GpsrSybil : public RoutingProtocolBase, public cListener, public NetfilterBase::HookBase
{
  private:
    // GPSR parameters
  ...
  private:
    ...
    // handling beacons
    const Ptr<GpsrBeaconSecure> createBeaconSybil(const char* addressStr);
