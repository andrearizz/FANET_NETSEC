...
class INET_API GpsrCoordinateNormale : public RoutingProtocolBase, public cListener, public NetfilterBase::HookBase
{
  private:
    // GPSR parameters
  ...
  public:
    GpsrCoordinateNormale();
    virtual ~GpsrCoordinateNormale();
  ...
  private:
    ...
    // handling beacons
    const Ptr<GpsrBeacon> createBeacon(const char* addressStr);
