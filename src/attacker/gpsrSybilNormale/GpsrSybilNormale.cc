...
Define_Module(GpsrSybilNormale);
...
GpsrSybilNormale::GpsrSybilNormale()
{
}
...
void GpsrSybilNormale::initialize(int stage)
{
...
void GpsrSybilNormale::handleMessageWhenUp(cMessage *message)
{
...
void GpsrSybilNormale::processSelfMessage(cMessage *message)
{
...
void GpsrSybilNormale::processMessage(cMessage *message)
{
...
void GpsrSybilNormale::processBeaconTimer()
{
    ...
    if (!selfAddress.isUnspecified()) {
        sendBeacon(createBeaconSybil(("host["+std::to_string(rand() % 25) + "]").c_str()));
...
void GpsrSybilNormale::schedulePurgeNeighborsTimer()
{
...
void GpsrSybilNormale::processPurgeNeighborsTimer()
{
...
void GpsrSybilNormale::sendUdpPacket(Packet *packet)
{
    std::cout << "------------Attaccante--------------" << endl;
    send(packet, "ipOut");
}

void GpsrSybilNormale::processUdpPacket(Packet *packet)
{
...
const Ptr<GpsrBeacon> GpsrSybilNormale::createBeaconSybil(const char* addressStr)
{
...
void GpsrSybilNormale::sendBeacon(const Ptr<GpsrBeacon>& beacon)
{
    EV_INFO << "Sending sybil beacon: address = " << beacon->getAddress() << ", position = " << beacon->getPosition() << endl;
    Packet *udpPacket = new Packet("GpsrSybilNormaleBeacon");
...
void GpsrSybilNormale::processBeacon(Packet *packet)
{
...
GpsrOption* GpsrSybilNormale::createGpsrOption(L3Address destination)
{
...
int GpsrSybilNormale::computeOptionLength(GpsrOption *option)
{
    // routingMode
...
void GpsrSybilNormale::configureInterfaces()
{
...
// KLUDGE: implement position registry protocol
PositionTable GpsrSybilNormale::globalPositionTable;

Coord GpsrSybilNormale::lookupPositionInGlobalRegistry(const L3Address& address) const
{
    // KLUDGE: implement position registry protocol
    return globalPositionTable.getPosition(address);
}

void GpsrSybilNormale::storePositionInGlobalRegistry(const L3Address& address, const Coord& position) const
{
    // KLUDGE: implement position registry protocol
    globalPositionTable.setPosition(address, position);
}

void GpsrSybilNormale::storeSelfPositionInGlobalRegistry() const
{
...
Coord GpsrSybilNormale::computeIntersectionInsideLineSegments(Coord& begin1, Coord& end1, Coord& begin2, Coord& end2) const
{
...
Coord GpsrSybilNormale::getNeighborPosition(const L3Address& address) const
{
...
double GpsrSybilNormale::getVectorAngle(Coord vector) const
{
...
double GpsrSybilNormale::getNeighborAngle(const L3Address& address) const
{
...
std::string GpsrSybilNormale::getHostName() const
{
    return host->getFullName();
}

L3Address GpsrSybilNormale::getSelfAddress() const
{
...
L3Address GpsrSybilNormale::getSenderNeighborAddress(const Ptr<const NetworkHeaderBase>& networkHeader) const
{
...
simtime_t GpsrSybilNormale::getNextNeighborExpiration()
{
...
void GpsrSybilNormale::purgeNeighbors()
{
    neighborPositionTable.removeOldPositions(simTime() - neighborValidityInterval);
}

std::vector<L3Address> GpsrSybilNormale::getPlanarNeighbors() const
{
...
std::vector<L3Address> GpsrSybilNormale::getPlanarNeighborsCounterClockwise(double startAngle) const
{
...
L3Address GpsrSybilNormale::findNextHop(const L3Address& destination, GpsrOption *gpsrOption)
{
...
L3Address GpsrSybilNormale::findGreedyRoutingNextHop(const L3Address& destination, GpsrOption *gpsrOption)
{
...
L3Address GpsrSybilNormale::findPerimeterRoutingNextHop(const L3Address& destination, GpsrOption *gpsrOption)
{
...
INetfilter::IHook::Result GpsrSybilNormale::routeDatagram(Packet *datagram, GpsrOption *gpsrOption)
{
...
void GpsrSybilNormale::setGpsrOptionOnNetworkDatagram(Packet *packet, const Ptr<const NetworkHeaderBase>& networkHeader, GpsrOption *gpsrOption)
{
    packet->trimFront();
#ifdef WITH_IPv4
...
const GpsrOption *GpsrSybilNormale::findGpsrOptionInNetworkDatagram(const Ptr<const NetworkHeaderBase>& networkHeader) const
{
...
GpsrOption *GpsrSybilNormale::findGpsrOptionInNetworkDatagramForUpdate(const Ptr<NetworkHeaderBase>& networkHeader)
{
...
const GpsrOption *GpsrSybilNormale::getGpsrOptionFromNetworkDatagram(const Ptr<const NetworkHeaderBase>& networkHeader) const
{
    const GpsrOption *gpsrOption = findGpsrOptionInNetworkDatagram(networkHeader);
    if (gpsrOption == nullptr)
        throw cRuntimeError("GpsrSybilNormale option not found in datagram!");
    return gpsrOption;
}

GpsrOption *GpsrSybilNormale::getGpsrOptionFromNetworkDatagramForUpdate(const Ptr<NetworkHeaderBase>& networkHeader)
{
...
INetfilter::IHook::Result GpsrSybilNormale::datagramPreRoutingHook(Packet *datagram)
{
...
INetfilter::IHook::Result GpsrSybilNormale::datagramLocalOutHook(Packet *packet)
{
...
void GpsrSybilNormale::handleStartOperation(LifecycleOperation *operation)
{
    configureInterfaces();
    storeSelfPositionInGlobalRegistry();
    scheduleBeaconTimer();
...
void GpsrSybilNormale::handleStopOperation(LifecycleOperation *operation)
{
...
void GpsrSybilNormale::handleCrashOperation(LifecycleOperation *operation)
{
    neighborPositionTable.clear();
    cancelEvent(beaconTimer);
    cancelEvent(purgeNeighborsTimer);
...
void GpsrSybilNormale::receiveSignal(cComponent *source, simsignal_t signalID, cObject *obj, cObject *details)
{
