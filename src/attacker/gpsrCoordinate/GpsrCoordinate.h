...
class INET_API GpsrCoordinate : public RoutingProtocolBase, public cListener, public NetfilterBase::HookBase
{
  private:
    // GPSR parameters
  ...
  private:
    ...
    // handling beacons
    const Ptr<GpsrBeaconSecure> createBeacon(const char* addressStr);
